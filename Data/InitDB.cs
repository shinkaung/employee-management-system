        ...
        */
        ...
        private static void SeedData(AppDbContext ctx, bool isProduction)
        {
            ...
            if (!ctx.Users.Any())
            {
                ...
                ctx.Users.AddRange(
                    new User { Username = "admin", Password = "P@s5w0rd", Email = "admin@example.com", Role = "admin", EmployeeId = 4 },
                    new User { Username = "user", Password = "P@s5w0rd", Email = "user@example.com", Role = "user", EmployeeId = 10 },
                    new User { Username = "john_doe", Password = "Johndoe@123", Email = "john.doe@example.com", Role = "admin", EmployeeId = 1 },
                    new User { Username = "jane_smith", Password = "Jan3Smith!", Email = "jane.smith@example.com", Role = "user", EmployeeId = 2 },
                    new User { Username = "charlie_brown", Password = "Peanuts!123", Email = "charlie.brown@example.com", Role = "admin", EmployeeId = 56 },
                    new User { Username = "sarah_jones", Password = "S@rah1234", Email = "sarah.jones@example.com", Role = "user", EmployeeId = 28 },
                    new User { Username = "michael_clark", Password = "M1ch@elC", Email = "michael.clark@example.com", Role = "admin", EmployeeId = 11 },
                    new User { Username = "emily_white", Password = "Em1lyW!te", Email = "emily.white@example.com", Role = "user", EmployeeId = 33 },
                    new User { Username = "david_thompson", Password = "D@v1dT!", Email = "david.thompson@example.com", Role = "admin", EmployeeId = 60 },
                    new User { Username = "amanda_green", Password = "Gr33nTea@", Email = "amanda.green@example.com", Role = "user", EmployeeId = 51 },
                    new User { Username = "peter_wilson", Password = "W1lsonPeter", Email = "peter.wilson@example.com", Role = "admin", EmployeeId = 44 },
                    new User { Username = "linda_miller", Password = "Lind@M1ll3r", Email = "linda.miller@example.com", Role = "admin", EmployeeId = 25 },
                    new User { Username = "robert_jackson", Password = "R0bJ@ck!", Email = "robert.jackson@example.com", Role = "user", EmployeeId = 6 },
                    new User { Username = "susan_carter", Password = "C@rt3rSu$an", Email = "susan.carter@example.com", Role = "user", EmployeeId = 49 },
                    new User { Username = "matthew_harris", Password = "M@tth3w123", Email = "matthew.harris@example.com", Role = "user", EmployeeId = 14 },
                    new User { Username = "olivia_baker", Password = "B@k3rOl1v!", Email = "olivia.baker@example.com", Role = "admin", EmployeeId = 38 },
                    new User { Username = "samuel_taylor", Password = "T@ylorS@m", Email = "samuel.taylor@example.com", Role = "user", EmployeeId = 22 }
                );
                ctx.SaveChanges();
                Console.WriteLine("========== User Data Seeding Successful ==========");
            }
            else
            {
                Console.WriteLine("User Data Already Existed");
            }
            ...
            if (!ctx.Departments.Any())
            {
                ...
                ctx.Departments.AddRange(
                    new Department { DepartmentCode = "D001", DepartmentName = "Information Technology", HeadOfDepartmentId = 1 },
                    new Department { DepartmentCode = "D002", DepartmentName = "Finance & Accounting", HeadOfDepartmentId = 5 },
                    new Department { DepartmentCode = "D003", DepartmentName = "Human Resource", HeadOfDepartmentId = 8 },
                    new Department { DepartmentCode = "D004", DepartmentName = "Sales & Marketing", HeadOfDepartmentId = 17 },
                    new Department { DepartmentCode = "D005", DepartmentName = "Research & Development", HeadOfDepartmentId = 20 },
                    new Department { DepartmentCode = "D006", DepartmentName = "Administration", HeadOfDepartmentId = 25 },
                    new Department { DepartmentCode = "D007", DepartmentName = "Security", HeadOfDepartmentId = 29 },
                    new Department { DepartmentCode = "D008", DepartmentName = "Manufacturing", HeadOfDepartmentId = 34 },
                    new Department { DepartmentCode = "D009", DepartmentName = "Operation", HeadOfDepartmentId = 38 },
                    new Department { DepartmentCode = "D010", DepartmentName = "Customer Service", HeadOfDepartmentId = 41 },
                    new Department { DepartmentCode = "D011", DepartmentName = "Business Development", HeadOfDepartmentId = 47 },
                    new Department { DepartmentCode = "D012", DepartmentName = "Logistics", HeadOfDepartmentId = 50 }
                );
                ctx.SaveChanges();
